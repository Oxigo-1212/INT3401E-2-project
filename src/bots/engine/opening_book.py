...
# Value: Danh sách các nước đi (đã mã hóa thành int) 
OPENING_BOOK: dict[int, list[int]] = {}

def add_opening(move_sequence: list[str], response_moves: list[str]):
    """
    Thêm một nhánh khai cuộc vào sổ.
    
    Args:
        move_sequence: Danh sách các nước đi từ đầu game. VD: ["h7e7", "h0g2"]
        response_moves: Các nước phản hồi khuyên dùng ở thế cờ hiện tại. VD: ["h9g7", "b9c7"]
    """
    board = Board()
...
# ---------------- THUẬN PHÁO (SAME DIRECTION CANNON) ----------------
...
# ---------------- NGHỊCH PHÁO (OPPOSITE DIRECTION CANNON) ----------------
...
# ---------------- QUÁ CUNG PHÁO (CROSS-PALACE CANNON) ----------------
