...
*   **Thuật toán tìm kiếm cốt lõi:**
    *   **Minimax & Negamax:** Dùng để duyệt cây trò chơi, tìm ra nước cờ tối ưu hóa lợi ích của bản thân và thu hẹp lợi ích của đối thủ.
    *   **Alpha-Beta Pruning (Cắt tỉa Alpha-Beta):** Kỹ thuật loại bỏ các nhánh tìm kiếm không tiềm năng, giúp tăng tốc độ tìm kiếm lên đáng kể so với Minimax thuần túy.
