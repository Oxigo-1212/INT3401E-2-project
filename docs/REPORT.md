...
<<<<<<< HEAD
   - **`algorithm.py`:** Triển khai thuật toán Negamax kết hợp Cắt tỉa Alpha-Beta. Đây là module định tuyến chính để duyệt không gian trạng thái. Thuật toán được tối ưu thời gian chạy bằng kỹ thuật *Null Move Pruning*.
=======
