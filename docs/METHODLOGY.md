...
$$E = w_m \cdot E_{\text{material}} + w_p \cdot E_{\text{position}} + w_k \cdot E_{\text{king\_safety}} + w_b \cdot E_{\text{mobility}} + w_r \cdot E_{\text{rook\_open}}$$
...
$$\phi = \frac{\sum_{p \notin \{\text{K, k}\}} \text{PIECE\_VALUE}(p) - 1200}{2400 - 1200}, \quad \phi \in [0, 1]$$
